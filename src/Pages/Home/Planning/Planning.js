                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 group">
                    <div className="bg-gradient-to-r from-sky-500 hover:from-sky-500 hover:to-blue-500 to-sky-300 p-[3px] group-hover:scale-90 hover:!scale-110 rounded-lg duration-700">
                        <div className="bg-white rounded-lg shadow-md p-6 text-center border h-full">
                            <h3 className="text-lg text-[#05BFDB] font-bold mb-2">
                            Recharge Recycling
                            </h3>
                    ...
                    <div className="bg-gradient-to-r from-sky-500 hover:from-sky-500 hover:to-blue-500 to-sky-300 p-[3px] group-hover:scale-90 hover:!scale-110 rounded-lg duration-700">
                        <div className="bg-white rounded-lg shadow-md p-6 text-center border  h-full">
                            ...
                            <p className="text-gray-600">
                            The producer organisations are joining forces to collect, sort and recycle waste electrical and electronic appliances and batteries.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-sky-500 hover:from-sky-500 hover:to-blue-500 to-sky-300 p-[3px] group-hover:scale-90 hover:!scale-110 rounded-lg duration-700">
                        <div className="bg-white rounded-lg shadow-md p-6 text-center border  h-full">
                            <h3 className="text-lg text-[#05BFDB] font-bold mb-2"> ReNew Battery Solutions</h3>
                            <p className="text-gray-600">
                            Whether it's an automotive, marine or deep cycle battery our trained Team are here to help and charge it ready for your next adventure.
                            </p>
                        </div>
                    </div>
                </div>
